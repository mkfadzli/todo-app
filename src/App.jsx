...
function App() {
  const [tasks, setTasks] = useState(() => {
    ...
    return savedTasks ? JSON.parse(savedTasks) : [
      ...
      { id: 6, text: "Doa diberi kesihatan yg baik, jauh dari semua penyakit kritikal berbahaya", completed: false },
      { id: 7, text: "Doa dipanjangkan umur, dijauhkan dari buruknya hari tua, dan smg mendapat pengakhiran yg baik", completed: false },
      { id: 8, text: "Doa dikurniakan rezeki anak2 yg soleh solehah yg bijak2 yg cantik2 handsome2", completed: false },
      { id: 9, text: "Doa diluaskan rezeki, dibukakan segala pintu2 rezeki dari semua sumber", completed: false },
      ...
      { id: 13, text: "Doa diberi kebahagian dan ketenangan hidup, bertambah kasih syg dalam keluarga sakinah, dgn rakan2 dan org sekeliling ", completed: false },
      { id: 14, text: "Doa dikurniakan ramai sahabat, kenalan yg baik2, network yg luas..", completed: false },
      { id: 15, text: "Doa dijauhkan dari perasaan hasad dengki makhluk ", completed: false },
      { id: 16, text: "Doa dijauhkan dari kejahatan manusia dan jin serta makhluk halus lain ", completed: false },
      { id: 17, text: "Doa smg dapat keluar dari segala hutang, capai financial freedom, financial independent", completed: false },
      { id: 18, text: "Doa smg dapat membuka perniagaan sendiri, franschise ", completed: false },
      { id: 19, text: "Doa smg nama dapat dikeluarkan dari senarai hitam keluar negara, ada rezeki utk dtg umrah next year", completed: false },
      ...
      { id: 22, text: "Doa tercapai segala impian, hajat, cita2, impian.", completed: false },
      { id: 23, text: "Doa smg selamat dari siksaan azab kubur dan hitungan di padang mahsyar dan api neraka. ", completed: false },
    ];
  });
